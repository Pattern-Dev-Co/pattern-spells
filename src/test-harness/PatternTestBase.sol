...
import { PatternLiquidityLayerTests } from "./PatternLiquidityLayerTests.sol";
...
abstract contract PatternTestBase is PatternLiquidityLayerTests, CommonSpellAssertions, CommonTestBase {
}
